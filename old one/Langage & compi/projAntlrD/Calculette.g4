...
decl returns [ String code ]
    :
        TYPE IDENTIFIANT finInstruction
        {
            ...
            $code="PUSH"+($TYPE.text.equals("float") ? "F 0." : "I 0") +"\n";
            $code+="#"+$TYPE.text+" \n";
        }
...
condition returns [String code]
    ...
    | cond1=condition AND cond2=condition
        {
            $code = "# Condition d'egalite : cond1 and cond2\n";
    ...
    | cond1=condition OR cond2=condition
        {
            $code = "# Condition d'egalite : cond1 or cond2\n";
    ...
    | expr1=expression op=('=='|'>'|'>='|'<>'|'!='|'<'|'<=') expr2=expression {
        $code = "# Condition d'egalite : expr1 " +  $op.text + " expr2\n";
